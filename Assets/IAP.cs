...
// one of the existing Survival Shooter scripts.
    ...
    {
        public static IAP instance { set; get; }
        ...
        public static string kProductIDConsumable1 = "amount_1";  // amount_1
        public static string kProductIDConsumable2 = "amount_2";  // amount_2
        public static string kProductIDConsumable3 = "amount_3";  // amount_3
    ...
    public void BuyNonConsumable()
        ...
        {
            Debug.Log(string.Format("ProcessPurchase: PASS. Product: '{0}'", args.purchasedProduct.definition.id));
            playercomp.data.Profile.Money += 15000;
            playercomp.SaveData();
            // TODO: The non-consumable item has been successfully purchased, grant this item to the player.
        }
        else
